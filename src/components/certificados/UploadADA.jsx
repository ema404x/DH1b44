...
export default function UploadADA({ onExtracted }) {
  ...
  const [step, setStep] = useState('idle'); // idle | uploading | reading | done
  ...
  const stepLabel = {
    ...
    reading: 'La IA está leyendo el ADA...',
  ...
  return (
    <div className="max-w-xl mx-auto mt-12">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground text-sm mt-1">La IA va a leer el PDF y extraer todos los datos automáticamente</p>
      </div>
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-xs text-muted-foreground mt-1">Solo archivos PDF • ADA / Orden de Compra</p>
